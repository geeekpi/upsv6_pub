...
while True:
    ...
    tft.drawCircle(120, 120, 31, 0xF800)
    tft.drawCircle(120, 120, 32, 0xF800)
    Device.sleep(500)
    tft.drawCircle(120, 120, 40, 0x001F) 
    tft.drawCircle(120, 120, 41, 0x001F) 
    tft.drawCircle(120, 120, 42, 0x001F) 
    Device.sleep(500)
    tft.drawCircle(120, 120, 50, 0x07E0)
    tft.drawCircle(120, 120, 51, 0x07E0)
    tft.drawCircle(120, 120, 52, 0x07E0)
    Device.sleep(500)
    tft.drawCircle(120, 120, 60, 0x0000)
    tft.drawCircle(120, 120, 61, 0x0000)
    tft.drawCircle(120, 120, 62, 0x0000)
    Device.sleep(5000)
